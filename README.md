...
- **GUI Framework:** PyQt5 (for the desktop application interface)  
- **Styling:** QDarkStyle (for a modern dark-themed UI)  
- **Threading:** PyQt5 QThread (for background threat detection)  
- **Testing:** Unittest (for running test cases)  
